 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.HALSystemImpl#getHomeAddress <em>Home Address</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.HALSystemImpl#getRules <em>Rules</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.HALSystemImpl#getActivitylog <em>Activitylog</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.HALSystemImpl#getReadings <em>Readings</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.HALSystemImpl#getCommands <em>Commands</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.HALSystemImpl#getRooms <em>Rooms</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.HALSystemImpl#getSensors <em>Sensors</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.HALSystemImpl#getActuators <em>Actuators</em>}</li>
 * </ul>
 *
 * @generated
 */
