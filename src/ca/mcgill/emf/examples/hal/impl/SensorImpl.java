 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.SensorImpl#getRoom <em>Room</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.SensorImpl#getReadings <em>Readings</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.impl.SensorImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SensorImpl extends NamedElementImpl implements Sensor {
		...
		if (room != null && room.eIsProxy()) {
			...
			if (room != oldRoom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HalPackage.SENSOR__ROOM, oldRoom, room));
			}
		}
		return room;
	}
	...
	public NotificationChain basicSetRoom(Room newRoom, NotificationChain msgs) {
		...
		room = newRoom;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HalPackage.SENSOR__ROOM, oldRoom, newRoom);
	...
	public void setRoom(Room newRoom) {
		if (newRoom != room) {
			...
			if (room != null)
				msgs = ((InternalEObject)room).eInverseRemove(this, HalPackage.ROOM__SENSORS, Room.class, msgs);
			if (newRoom != null)
				msgs = ((InternalEObject)newRoom).eInverseAdd(this, HalPackage.ROOM__SENSORS, Room.class, msgs);
			msgs = basicSetRoom(newRoom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HalPackage.SENSOR__ROOM, newRoom, newRoom));
	}
	...
	public EList<SensorReading> getReadings() {
		if (readings == null) {
			readings = new EObjectWithInverseResolvingEList<SensorReading>(SensorReading.class, this, HalPackage.SENSOR__READINGS, HalPackage.SENSOR_READING__SENSOR);
		}
		return readings;
	}
