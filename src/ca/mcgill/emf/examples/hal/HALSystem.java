 ...
 * </p>
 * <ul>
 *   <li>{@link ca.mcgill.emf.examples.hal.HALSystem#getHomeAddress <em>Home Address</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.HALSystem#getRules <em>Rules</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.HALSystem#getActivitylog <em>Activitylog</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.HALSystem#getReadings <em>Readings</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.HALSystem#getCommands <em>Commands</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.HALSystem#getRooms <em>Rooms</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.HALSystem#getSensors <em>Sensors</em>}</li>
 *   <li>{@link ca.mcgill.emf.examples.hal.HALSystem#getActuators <em>Actuators</em>}</li>
 * </ul>
 *
...
public interface HALSystem extends EObject {
	 ...
	 * @see ca.mcgill.emf.examples.hal.HalPackage#getHALSystem_HomeAddress()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ca.mcgill.emf.examples.hal.HALSystem#getHomeAddress <em>Home Address</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.mcgill.emf.examples.hal.HalPackage#getHALSystem_Activitylog()
	...
	/**
	 * Sets the value of the '{@link ca.mcgill.emf.examples.hal.HALSystem#getActivitylog <em>Activitylog</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ca.mcgill.emf.examples.hal.HalPackage#getHALSystem_Readings()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see ca.mcgill.emf.examples.hal.HalPackage#getHALSystem_Commands()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see ca.mcgill.emf.examples.hal.HalPackage#getHALSystem_Rooms()
	 * @model containment="true"
	 * @generated
	 */
	EList<Room> getRooms();
	 ...
	 * @see ca.mcgill.emf.examples.hal.HalPackage#getHALSystem_Sensors()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see ca.mcgill.emf.examples.hal.HalPackage#getHALSystem_Actuators()
	 * @model containment="true"
	 * @generated
	 */
